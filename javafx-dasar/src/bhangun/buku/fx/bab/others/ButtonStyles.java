...
public class ButtonStyles extends Application {
    ...
    @Override public void start(Stage primaryStage) {
        ...
        //  .stylesheets(ButtonStyles.class.getResource("bhangun/resources/Buttons.css").toExternalForm())
        
        	.stylesheets(getClass().getResource("/bhangun/book/resources/Buttons.css").toExternalForm())
            .fill(Color.gray(0.9))
            .root(
